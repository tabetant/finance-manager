...
import { KeypointOverlay } from "./keypoint-overlay";
        ...
        >
          ...
          <div className="relative bg-muted rounded-lg overflow-hidden mb-4 group">
            ...
            >
              ...
              >
                Text Block Identified
              </motion.text>

              {/* Segmentation Masks */}
              <motion.path
                d="M 15% 50% Q 50% 45%, 85% 50% L 85% 80% Q 50% 85%, 15% 80% Z"
                fill="#FF9100"
                fillOpacity="0.1"
                stroke="#FF9100"
                strokeWidth="1"
            ...
            <motion.div
              className="absolute inset-0 bg-gradient-to-b from-accent/0 via-accent/20 to-accent/0"
              initial={{ y: "-100%" }}
              animate={{ y: "100%" }}
              transition={{
                repeat: Infinity,
